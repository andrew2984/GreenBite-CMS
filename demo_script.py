...
def main():
    ...
    events = []
    event_data = [
        (clients[0], "Annual Corporate Lunch", "Downtown Venue", "Corporate lunch event", 500.0, 30),
        (clients[1], "Sarah & Tom's Wedding", "Garden Hall", "Wedding reception", 2000.0, 45),
        (clients[2], "Michael's 30th Birthday Bash", "Community Center", "Birthday party", 300.0, 60),
        (clients[3], "Tech Conference 2026", "Convention Center", "Annual tech summit", 1500.0, 75),
        (clients[4], "Charity Gala Dinner", "Elegant Ballroom", "Fundraiser event", 3000.0, 90),
        (clients[5], "Product Launch Party", "Modern Gallery", "New product reveal", 2500.0, 35),
        (clients[6], "Family Reunion Picnic", "Riverside Park", "Extended family gathering", 800.0, 120),
        (clients[7], "Corporate Team Building", "Adventure Zone", "Outdoor team activities", 1200.0, 55),
        (clients[8], "Art Exhibition Opening", "Fine Arts Museum", "Contemporary art showcase", 1000.0, 20),
        (clients[9], "Anniversary Celebration", "Rooftop Restaurant", "Golden wedding anniversary", 1500.0, 40),
        (clients[10], "Graduation Party", "Beach Resort", "Celebratory graduation event", 2200.0, 65),
        (clients[11], "Holiday Festival", "Town Square", "Season celebration with festivities", 5000.0, 10),
        (clients[12], "Networking Breakfast", "Business Club", "Professional networking event", 600.0, 50),
    ]
